    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              SvgPicture.asset(icon, colorFilter: ColorFilter.mode((isSelected && isCancel) ? const Color(0xFFF44336) : isSelected ? const Color(0xFF1E88E5) : AppColors.c_800, BlendMode.srcIn),),
              12.pw,
              Text(title,
                style: TextStyle(
                    fontSize: 15.sp,
